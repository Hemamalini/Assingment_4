...
public class Editlead {
	...
	public static void main(String[] args) {
		...
		WebElement smallEditElement = driver.findElement(By.linkText("Edit"));
		smallEditElement.click();
		WebElement newdescriptionLocalElement = driver.findElement(By.id("updateLeadForm_description"));
		newdescriptionLocalElement.clear();
		WebElement importantNoteElement = driver.findElement(By.id("updateLeadForm_importantNote"));
		importantNoteElement.sendKeys("BM LOCATED IN not only CHENNAI but also in CBE");
		WebElement NewupdateElement = driver.findElement(By.className("smallSubmit"));
		NewupdateElement.click();
